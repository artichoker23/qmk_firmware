...
// #define ENABLE_RGB_MATRIX_HUE_PENDULU
...
#define ENABLE_RGB_MATRIX_CUSTOM_JSTATIC

/* Enable receive custom command from host */
#define RAW_HID_CMD 0xAB

#define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_CUSTOM_JSTATIC
